/* 
 * Original project based on hid-data example by Christian Starkjohann
 * License: GNU GPL v3 
 */
...
int             err;
    ...
    if((err = usbhidOpenDevice(&dev, vid, vendorName, pid, productName, 0)) != 0){
        fprintf(stderr, "error finding %s: %s (vendor %s)\n", productName, usbErrorMessage(err), vendorName);
